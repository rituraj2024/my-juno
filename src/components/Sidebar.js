...
const Sidebar = () => {
  return (
    <div className="w-full md:w-[258px] h-full md:h-[800px] px-4 md:px-8 pt-8 md:pt-12 pb-8 bg-white border-r border-neutral-200 flex-col justify-between items-start inline-flex">
      <div className="self-stretch md:h-[405.60px] flex-col justify-start items-start gap-6 md:gap-12 flex">
        <img className="w-full h-auto md:w-[194px] md:h-[77.60px]" src={logo} alt="logo" />
        <div className="self-stretch md:h-[280px] flex-col justify-start items-start gap-2 flex">
          <div className="hover-container hover:bg-indigo-600 hover:bg-opacity-10 self-stretch px-4 py-2.5 rounded-[7px] justify-start items-center gap-3 inline-flex">
            <div className="text-neutral-500 text-base font-medium font-['Lettera Text LL']">
              <p>Overview</p>
            </div>
          </div>
          <div className="hover-container hover:bg-indigo-600 hover:bg-opacity-10 self-stretch px-4 py-2.5 rounded-[7px] justify-start items-center gap-3 inline-flex">
          ...
          <div className="hover-container hover:bg-indigo-600 hover:bg-opacity-10 self-stretch px-4 py-2.5 rounded-[7px] justify-start items-center gap-3 inline-flex">
            <div className="w-[67px] text-neutral-500 text-base font-medium font-['Lettera Text LL']">
              <p>Flagginng</p>
            </div>
          </div>
          <div className="hover-container hover:bg-indigo-600 hover:bg-opacity-10 self-stretch px-4 py-2.5 rounded-[7px] justify-start items-center gap-3 inline-flex">
          ...
          <div className="hover-container hover:bg-indigo-600 hover:bg-opacity-10 w-full md:w-[194px] h-10 px-4 py-2.5 rounded-[7px] justify-start items-center gap-3 inline-flex">
            <div className="text-neutral-500 text-base font-medium font-['Lettera Text LL']">
              <p>UAR</p>
            </div>
          </div>
      ...
      <div className="w-full md:w-[204px] justify-start items-center gap-6 md:gap-20 inline-flex">
        <div className="justify-start items-center gap-2 flex">
          {
            <div className="w-[38px] h-[38px] justify-center items-center flex">
              <img className="w-[38px] h-[38px] rounded-full border-2 border-white" src={profileimage} alt="profileimg" />
